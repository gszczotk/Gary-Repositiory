...
age = 14
print(f"{name} can vote in {18-age} years") # can also do expressions inside the curly braces
...
# open file and store each line in a list called file, can also have second parameter to specify read or writing
